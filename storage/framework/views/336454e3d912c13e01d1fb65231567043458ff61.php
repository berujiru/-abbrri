                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <h6 class="fs-14 mb-0 flex-grow-1 text-truncate"><a href="<?php echo e(URL::asset('/apps-tasks-details')); ?>"
                ...
                <div id="todo-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-14 mb-0 text-truncate"><a href="<?php echo e(URL::asset('/apps-tasks-details')); ?>"
                ...
                <div id="inprogress-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-14 text-truncate"><a href="<?php echo e(URL::asset('/apps-tasks-details')); ?>" class="text-body">Brand
                                    Logo Design</a></h6>
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-14 text-truncate"><a href="<?php echo e(URL::asset('/apps-tasks-details')); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8\htdocs\lezhet\resources\views/apps-tasks-kanban.blade.php ENDPATH**/ ?>