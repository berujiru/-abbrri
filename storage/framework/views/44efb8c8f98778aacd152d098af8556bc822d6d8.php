                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="<?php echo e(URL::asset('assets/images/users/user-dummy-img.jpg')); ?>"
                                alt="Header Avatar">
...
<?php /**PATH C:\xampp8\htdocs\lezhet\resources\views/layouts/guest-topbar.blade.php ENDPATH**/ ?>